...
def prepare_opa_assessments(request):
    """
    HTTP-triggered Cloud Function: stream raw OPA assessment history CSV from GCS,
    ...
    """
    raw_uri = "gs://musa5090s26-team6-raw_data/opa_assessments/raw.csv"
    prepared_uri = "gs://musa5090s26-team6-prepared_data/opa_assessments/data.parquet"
