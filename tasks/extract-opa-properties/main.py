...
def extract_opa_properties(request):
    """
    HTTP-triggered Cloud Function: stream OPA properties CSV from S3 directly
    to GCS without buffering in memory.
    """
    url = "https://opendata-downloads.s3.amazonaws.com/opa_properties_public.csv"
    bucket_name = "musa5090s26-team6-raw_data"
    destination_blob_name = "opa_properties/raw.csv"
